...
<head>
    ...
    <title>Complete Order || Clothing</title>
...
<body>
    ...
    <div class="wrapper complete-order">
                            ...
                            <div class="title-tab-product-category row">
                                <div class="col-lg-12 text-center pb-60">
                                    <ul class="nav heading-style-3" role="tablist">
                                        ...
                                        <li role="presentation"><a class="active shadow-box" href="#complete-order"
                                                aria-controls="complete-order" role="tab" data-bs-toggle="tab"><span>03</span>
                                                complete-order</a></li>
                                    </ul>
                                </div>
                            </div>
                                                ...
                                                <div class="table-responsive mb-20">
                                                    <table class="shop_table-2 cart table">
                                                        ...
                                                        <tbody>
                                                            <tr class="cart_item">
                                                                <td class="item-img">
                                                                    <a href="#"><img src="images/product/01.jpg" alt="">
                                                                    </a>
                                                                </td>
                                                                <td class="item-title"> <a href="#">Fusce Laoreet
                                                                        Volutpat </a></td>
                                                                ...
                                                                <td class="total-price"><strong> $130.00</strong>
                                                                </td>
                                                                <td class="remove-item"><a href="#"><i
                                                                            class="fa fa-trash-o"></i></a></td>
                                                            </tr>
                                                            <tr class="cart_item">
                                                                <td class="item-img">
                                                                    <a href="#"><img src="images/product/02.jpg" alt="">
                                                                    </a>
                                                                </td>
                                                                <td class="item-title"> <a href="#">Fusce Laoreet
                                                                        Volutpat </a></td>
                                                                ...
                                                                <td class="total-price"><strong> $140.00</strong>
                                                                </td>
                                                                <td class="remove-item"><a href="#"><i
                                                                            class="fa fa-trash-o"></i></a></td>
                                                            </tr>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="input-box">
                                                                                        ...
                                                                                        <input type="text" name="zipcode"
                                                                                            class="info" placeholder="Zip Code">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-lg-12">
