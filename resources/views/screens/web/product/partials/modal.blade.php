                    ...
                    <div class="modal-product">
                                    ...
                                    <ul class="thumbnail-carousel-modal-2 nav" data-tabs="tabs">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="view1" data-bs-toggle="tab" href="#view1"
                                                ...
                                                <img src="{{asset('assets/web/images/product/no-image.png')}}" alt="" />
                                            </a>
                                        </li>
                        ...
                        <div class="product-info">
                            ...
                            <div class="price-box-3">
                                <div class="s-price-box"> <span class="new-price">PKR
                                        0</span> <span class="old-price"></span> </div>
                            </div> <a href="#" class="see-all">See all
                                features</a>

                            <div class="quick-desc"> Description</div>
