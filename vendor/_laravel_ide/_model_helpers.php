...
namespace App\Models {
     ...
     * @property float|null $effective_price
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereEffectivePrice($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereHasVariants($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product filter(mixed $filters = [])
     ...
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property string $error_log_message
     * @property mixed $error_log_generated_by_id
     * @property string|null $error_log_current_url
     * @property string|null $error_log_action_url
     * @property string|null $error_log_module
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<ErrorLog>|ErrorLog whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ErrorLog>|ErrorLog whereErrorLogModule($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ErrorLog>|ErrorLog whereErrorLogActionUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ErrorLog>|ErrorLog whereErrorLogCurrentUrl($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ErrorLog>|ErrorLog whereErrorLogGeneratedById($value)
     * @method static \Illuminate\Database\Eloquent\Builder<ErrorLog>|ErrorLog whereErrorLogMessage($value)
     ...
     * @property string|null $errors_file
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereFilename($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereFilepath($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereStatus($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereProcessed($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereFailed($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereErrorsFile($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Import>|Import query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class Import extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property string $name
     * @property string $sripe_product_id
     * @property string $sripe_price_id
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereSripePriceId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereSripeProductId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereName($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereAmount($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Plan>|Plan whereUses($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<ProductVariant>|ProductVariant whereEffectivePrice($value)
